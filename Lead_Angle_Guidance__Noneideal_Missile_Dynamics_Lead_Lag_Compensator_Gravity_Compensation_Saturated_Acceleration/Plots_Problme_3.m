%% Plots_Guidance_and_Navigation_HW#2_Problem_3
...
%% Time_To_Go_Real_VS_Time_To_Go_Approximation
figure('Name','Time To Go')
...
hold on
plot(t_go)
title('Time To Go Real vs Time To Go Approximation(None Zero Dyanmic & Lead-Lag Guidance Coeff.)')
legend('t_g real','t_g approximated')
xlabel('Time (s)')
ylabel('Time To Go (s)')